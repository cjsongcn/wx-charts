...
let Charts = function (opts, _component) {
  ...
  config.pieChartLinePadding =
    opts.dataLabel === false ? 0 : config.pieChartLinePadding;
  config.pieChartTextPadding =
    opts.dataLabel === false ? 0 : config.pieChartTextPadding;
  ...
  if (this.opts.type === "line" || this.opts.type === "area") {
    ...
    if (index > -1) {
      ...
      if (seriesData.length !== 0) {
        let { textList, offset } = getToolTipData(
          seriesData,
